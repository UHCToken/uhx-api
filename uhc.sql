...
CREATE TABLE IF NOT EXISTS user_claims(
    ...
    CONSTRAINT fk_user_claims_user FOREIGN KEY (user_id) REFERENCES users(user_id)
)
...
CREATE TABLE IF NOT EXISTS group (
    ...
    creation_time TIMETSAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP, -- THE TIME THAT THE OBJECT WAS CREATED
