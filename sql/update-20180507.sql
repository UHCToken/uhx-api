...
CREATE TABLE IF NOT EXISTS purchase (
    ...
    charge_amount NUMERIC(20,8) NOT NULL, -- THE AMOUNT IN charge_currency THAT WAS RECEIVED
    ...
    amount NUMERIC(20,8) NOT NULL, -- THE AMOUNT OF ASSETS THAT WERE TRANSFERRED TO THE ACCOUNT
